...
addCategoryToRegionImport("food", {"Necrom", "Ald-ruhn", "Red Mountain", "Maar Gan", "Ghostgate", "Dagon Fel", "Old Ebonheart", "Ebonheart", "Firewatch", "Helnim", "Arvud", "Molag Mar", "Dragonstar East", "Dragonstar West", "Stirk", "Nivalis", "Padomaic Ocean Region", "Distant Horizon", "Anvil", "Charach"})
